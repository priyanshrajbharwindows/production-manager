...
import { EditBOMDialog } from "./edit-bom-dialog"
import { DeleteBOMDialog } from "./delete-bom-dialog"
                      ...
                      <TableRow key={item.id}>
                        ...
                        <TableCell>
                          <div className="flex items-center justify-end gap-0.5">
                            <EditBOMDialog bom={item} />
                            <DeleteBOMDialog bom={item} productName={product.name} />
                          </div>
                        </TableCell>
                      </TableRow>
                    )
